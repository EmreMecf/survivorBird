    ...
    public void render () {
        ...
        if (gameState ==1) {
            ...
            for (int i = 0; i < numberOfEnemies; i++) {
                ...
                enemyCircles[i] = new Circle(enemyX[i] + Gdx.graphics.getWidth() / 30,  Gdx.graphics.getHeight()/2 + enemyOffSet[i] + Gdx.graphics.getHeight() / 20,Gdx.graphics.getWidth() / 50);
                enemyCircles2[i] = new Circle(enemyX[i] + Gdx.graphics.getWidth() / 30,  Gdx.graphics.getHeight()/2 + enemyOffSet2[i] + Gdx.graphics.getHeight() / 20,Gdx.graphics.getWidth() / 50);
                enemyCircles3[i] = new Circle(enemyX[i] + Gdx.graphics.getWidth() / 30,  Gdx.graphics.getHeight()/2 + enemyOffSet3[i] + Gdx.graphics.getHeight() / 20,Gdx.graphics.getWidth() / 50);
            ...
            font2.draw(batch,"Game Over! Tap To Play Again!", Gdx.graphics.getWidth()/4,Gdx.graphics.getHeight()-450);
        ...
        font.draw(batch,"Score: "+ score,Gdx.graphics.getWidth()/2,Gdx.graphics.getHeight()-105);
       ...
       // shapeRenderer.circle(birdCircle.x,birdCircle.y,birdCircle.radius);
        ...
        for ( int i = 0; i < numberOfEnemies; i++) {
            //shapeRenderer.circle(enemyX[i] + Gdx.graphics.getWidth() / 30,  Gdx.graphics.getHeight()/2 + enemyOffSet[i] + Gdx.graphics.getHeight() / 20,Gdx.graphics.getWidth() / 45);
